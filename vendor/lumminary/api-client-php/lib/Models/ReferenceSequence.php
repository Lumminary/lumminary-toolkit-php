...
/**
 * ReferenceSequence Class Doc Comment
 *
 * @category Class
 * @package  Lumminary\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReferenceSequence implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReferenceSequence';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((strlen($this->container['sequence']) < 1)) {
    ...
    public function setSequence($sequence)
    {
        ...
        if ((strlen($sequence) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sequence when calling ReferenceSequence., must be bigger than or equal to 1.');
        }
