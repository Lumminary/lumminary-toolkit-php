...
class ClientGene implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'snps' => '\Lumminary\Client\Models\ClientSNP[]',
        'symbol' => 'string',
        'molecularLocation' => '\Lumminary\Client\Models\MolecularLocation'
    ];
    ...
    protected static $setters = [
        'snps' => 'setSnps',
        'symbol' => 'setSymbol',
        'molecularLocation' => 'setMolecularLocation'
    ];
    ...
    protected static $getters = [
        'snps' => 'getSnps',
        'symbol' => 'getSymbol',
        'molecularLocation' => 'getMolecularLocation'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['molecularLocation'] = isset($data['molecularLocation']) ? $data['molecularLocation'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['molecularLocation'] === null) {
            $invalidProperties[] = "'molecularLocation' can't be null";
        }
     ...
     * Sets snps
     *
     * @param \Lumminary\Client\Models\ClientSNP[] $snps snps
     *
     * @return $this
     */
    ...
    /**
     * Gets molecularLocation
     *
     * @return \Lumminary\Client\Models\MolecularLocation
     */
    public function getMolecularLocation()
    {
        return $this->container['molecularLocation'];
    }

    /**
     * Sets molecularLocation
     *
     * @param \Lumminary\Client\Models\MolecularLocation $molecularLocation Full location information for where the gene is placed
     *
     * @return $this
     */
    public function setMolecularLocation($molecularLocation)
    {
        $this->container['molecularLocation'] = $molecularLocation;
