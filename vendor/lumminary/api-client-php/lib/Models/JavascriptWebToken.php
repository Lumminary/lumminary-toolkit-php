...
/**
 * JavascriptWebToken Class Doc Comment
 *
 * @category Class
 * @package  Lumminary\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JavascriptWebToken implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JavascriptWebToken';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((strlen($this->container['accessToken']) < 1)) {
     ...
     * Sets accessToken
     *
     * @param string $accessToken The JWT containing the authorization token for further API calls
     *
     * @return $this
     */
    public function setAccessToken($accessToken)
    {
        ...
        if ((strlen($accessToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $accessToken when calling JavascriptWebToken., must be bigger than or equal to 1.');
        }
