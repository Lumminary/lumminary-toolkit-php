...
[**postProductAuthorization**](LumminaryAPISpecApi.md#postProductAuthorization) | **POST** /products/{productId}/authorizations/{authorizationId} | Singnal that processing is complete, without uploading any result
